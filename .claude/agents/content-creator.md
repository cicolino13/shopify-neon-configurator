...
description: Use this agent when you need SEO-optimized website copy, blog content, meta descriptions/title tags, keyword research, or cross-platform marketing content for a product launch. Examples: <example>Context: The configurator page needs copy and SEO before launch. user: "The configurator page has no real content yet, just placeholders" assistant: "I'll use the content-creator agent to write SEO-optimized copy, meta descriptions, and title tags for the page." <commentary>Website copy and on-page SEO fit content-creator.</commentary></example> <example>Context: Need a blog post to drive organic traffic. user: "We want a blog post about custom product configurators to rank on Google" assistant: "Let me use the content-creator agent to research keywords and write an SEO-optimized pillar article." <commentary>SEO content strategy is content-creator's core job.</commentary></example>
model: sonnet
---
