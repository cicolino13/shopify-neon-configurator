---
name: growth-hacker
description: Use this agent when you need rapid user acquisition strategies, viral loop design, growth experiments, or channel optimization for a product or website. Examples: <example>Context: A new configurator feature needs more visitors converting into leads. user: "How do we get more people to actually try the configurator?" assistant: "I'll use the growth-hacker agent to design acquisition experiments and a referral loop for the configurator." <commentary>Acquisition and conversion-funnel questions are growth-hacker's specialty.</commentary></example> <example>Context: Traffic is flat despite launch. user: "We launched but growth has stalled" assistant: "Let me use the growth-hacker agent to audit the funnel and design new growth experiments." <commentary>Diagnosing and fixing stalled growth is core growth-hacker work.</commentary></example>
model: sonnet
---
